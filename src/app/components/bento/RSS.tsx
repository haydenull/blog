...
const RSS = () => {
  return (
    <BentoCard
      url="/feed.xml"
      className="group flex items-center justify-center bg-gradient-to-br from-orange-100 to-orange-200 dark:from-orange-900 dark:to-orange-950"
    >
      <div className="relative flex h-[50px] w-[50px] items-center justify-center">
        ...
        <div>
          <StreamlineRssSymbolSolid className="relative text-3xl text-white transition-all duration-100 group-hover:text-6xl dark:text-zinc-200" />
