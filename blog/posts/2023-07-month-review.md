...
```html
<div
  class="bg-[linear-gradient(180deg,_#eab308_49.9%,_#a855f7_50%)]"
></div>
```
...
```html
<div class="h-[600px] bg-blue-200 pb-4 rounded-tl-[24px] overflow-auto">
  container
  <div class="h-[400px] w-1/2 overflow-auto bg-red-200 pb-4">
    <div class="h-[500px] w-3/4 bg-orange-200"></div>
  </div>
</div>
```
